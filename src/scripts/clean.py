# this script cleans the OMI NO2 data (2005-2024)
# 1. extracts CloudScreenedTropNO2 data and creates new lat/lon grid
...
def extract_data(file_path):
    with h5py.File(file_path, 'r') as f: # read the hdf5 file
        data_path = '/HDFEOS/GRIDS/ColumnAmountNO2/Data Fields/ColumnAmountNO2TropCloudScreened'
...
def main():
    base_dir = "/home/ellab/air_pollution/src/data/new_no2" # this is where the new filtered files will go
        ...
        for filename in os.listdir(year_dir):
            if filename.endswith(".he5"):
                ...
                try:
                    ...
                    filtered_no2 = filter_no2(ds) # filter
